...
<img src="resource\SpringWeb概述.png" style="zoom:50%;" />
...
<img src="resource\访问静态资源.png" style="zoom:50%;" />
...
```java
org.springframework.boot.autoconfigure包下面的
...
<img src="resource\请求包装.png" style="zoom:67%;" />
...
<img src="resource\请求映射.png" style="zoom:80%;" />
...
<img src="resource\handlers.png" style="zoom:80%;" />

**RequestMappingHandlerMapping**：保存了所有@RequestMapping 和handler的映射规则。

<img src="resource\mappings.png" style="zoom:80%;" />
...
<img src="resource\Adapter.png" style="zoom:80%;" />
...
//ServletInvocableHandlerMethod中执行
...
<img src="resource\resolvers.png" style="zoom:80%;" />

<img src="resource\handlerResolver.png" style="zoom:80%;" />
...
<img src="resource\returnHandler.png" style="zoom:80%;" />

### 5.如何确定目标方法每一个参数的值

<img src="resource\获取参数值.png" style="zoom:80%;" />
...
- [3、webjar](#2DUvi)
- [2.2、欢迎页支持](#3l4XN)
- [2.3、自定义 Favicon](#DtC4H)
- [2.4、静态资源配置原理](#oD5QR)
- [1、配置类只有一个有参构造器](#Gcz5z)
- [2、资源处理的默认规则](#OMzHL)
- [3、欢迎页的处理规则](#KCCtT)
- [4、favicon](#vK4iZ)
- [3、请求参数处理](#yHWxm)
...
- [1、普通参数与基本注解](#xNDeL)
- [1.1、注解：](#SN5lp)
- [1.2、Servlet API：](#J5q9C)
- [1.3、复杂参数：](#AwwvT)
- [1.4、自定义对象参数：](#6ZjV8)
- [2、POJO封装过程](#lRjLb)
- [3、参数处理原理](#6SNoJ)
- [1、HandlerAdapter](#PAIV5)
- [2、执行目标方法](#ti8bK)
- [3、参数解析器-HandlerMethodArgumentResolver](#Nt8yT)
- [4、返回值处理器](#sZRok)
- [5、如何确定目标方法每一个参数的值](#efCYN)
- [5.1、挨个判断所有参数解析器那个支持解析这个参数](#AnfRX)
- [5.2、解析这个参数的值](#t7beO)
- [5.3、自定义类型参数 封装POJO](#zQ3D4)
- [6、目标方法执行完成](#Iaw3I)
- [7、处理派发结果](#sPfTr)
- [4、数据响应与内容协商](#ltqcb)
- [1、响应JSON](#NYElK)
- [1.1、jackson.jar+@ResponseBody](#OaZ4e)
- [1、返回值解析器](#y3QI0)
- [2、返回值解析器原理](#yC54O)
- [1.2、SpringMVC到底支持哪些返回值](#1YF7j)
- [1.3、HTTPMessageConverter原理](#Nf4qt)
- [1、MessageConverter规范](#Vsm4P)
- [2、默认的MessageConverter](#Zr0Du)
- [2、内容协商](#iZojv)
- [1、引入xml依赖](#VaOpX)
- [2、postman分别测试返回json和xml](#JRoPk)
- [3、开启浏览器参数方式内容协商功能](#9gTiL)
- [4、内容协商原理](#WJhZB)
- [5、自定义 MessageConverter](#5p9bU)
- [5、视图解析与模板引擎](#lzseb)
- [1、视图解析](#6V7bq)
- [1、视图解析原理流程](#ITRrl)
- [2、模板引擎-Thymeleaf](#E21jG)
- [1、thymeleaf简介](#Ci7un)
- [2、基本语法](#V14xB)
- [1、表达式](#eIYWe)
- [2、字面量](#5cYWw)
...
- [7、条件运算](#s6avh)
- [8、特殊操作](#UO85W)
- [3、设置属性值-th:attr](#MPYu8)
- [4、迭代](#th6mM)
- [5、条件运算](#3Pee5)
- [6、属性优先级](#Omg7c)
- [3、thymeleaf使用](#GWgDb)
- [1、引入Starter](#lapWh)
- [2、自动配置好了thymeleaf](#RI3E0)
- [3、页面开发](#h1Ewe)
- [4、构建后台管理系统](#B0ajH)
- [1、项目创建](#qNujo)
- [2、静态资源处理](#0tVo1)
...
- [3、异常处理自动配置原理](#52LdK)
- [4、异常处理步骤流程](#7ogXh)
- [9、Web原生组件注入（Servlet、Filter、Listener）](#xnb02)
- [1、使用Servlet API](#gmHIT)
- [2、使用RegistrationBean](#gxb71)
- [10、嵌入式Servlet容器](#ED2gi)
- [1、切换嵌入式Servlet容器](#lNYl3)
- [2、定制Servlet容器](#RlJkN)
- [11、定制化原理](#cQant)
- [1、定制化的常见方式](#eSDgT)
- [2、原理分析套路](#GH9jB)