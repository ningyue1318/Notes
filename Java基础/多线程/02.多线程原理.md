...
<img src="resources/JMM示意图.PNG" style="zoom: 80%;" />
...
<img src="resources\实验结果.PNG" style="zoom:80%;" />
...
<img src="resources\原子性示意图.PNG" style="zoom:80%;" />
...
<img src="resources/32位虚拟机结构.PNG" style="zoom: 67%;" />

32位虚拟机中对象头的组成
<img src="resources/32位虚拟机markword结构.PNG" style="zoom:67%;" />
64位虚拟机中对象头的组成

<img src="resources/64位虚拟机markword结构.PNG" style="zoom:67%;" />
...
- 同步：利用条件变量和条件变量等待队列。
  ...
  <img src="resources/MESA管程模型.PNG" style="zoom: 80%;" />
...
下面是Java中管程的实现
<img src="resources/Java中管程的实现.PNG" style="zoom:80%;" />
...
4. 当线程达到maximumPoolSize的时候，仍然有任务加入，会执行拒绝策略。
 ...
 <img src="resources\拒绝策略.PNG" style="zoom:67%;" />
...
<img src="resources\用到了AQS的队列.PNG" style="zoom:80%;" />
...
<img src="resources\ReentrantLock加锁失败.PNG" style="zoom: 50%;" /> <img src="\resources\ReentrantLock加锁失败2.PNG" style="zoom:50%;" />
...
<img src="resources\ReentrantLock解锁流程3.PNG" style="zoom: 80%;" />
...
<img src="resources\Queue框架图.PNG" style="zoom:60%;" />

<img src="resources\Map框架图.PNG" style="zoom:67%;" />
